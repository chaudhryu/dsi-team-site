...
switch (currentHostname) {
  ...
  case "dsiwebappdev.metro.net":
    ...
    break;
  // --- ITS Weekly Environment ---
  case "itsweekly.metro.net":
    determinedRedirectUri = "https://itsweekly.metro.net/auth-response";
    break;
  case "itsweeklydev.metro.net":
    determinedRedirectUri = "https://itsweeklydev.metro.net/auth-response";
    break;
...
export const msalConfig: Configuration = {
  auth: {
    ...
    authority: "https://login.microsoftonline.com/ab57129b-dbfd-4cac-aa77-fc74c40364af", // or B2C authority
